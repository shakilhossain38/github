...
flutter build apk --split-per-abi --flavor dev --target-platform android-arm,android-arm64 --release --tree-shake-icons --split-debug-info --obfuscate -t lib/main.dart
