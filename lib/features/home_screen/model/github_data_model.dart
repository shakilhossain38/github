...
//
//     final githubDataModel = githubDataModelFromJson(jsonString);

import 'dart:convert';

GithubDataModel githubDataModelFromJson(String str) =>
    GithubDataModel.fromJson(json.decode(str));

String githubDataModelToJson(GithubDataModel data) =>
...
class GithubDataModel {
  ...
  factory GithubDataModel.fromJson(Map<String, dynamic> json) =>
      GithubDataModel(
        totalCount: json["total_count"],
        incompleteResults: json["incomplete_results"],
        projectItems: json["items"] == null
            ? null
  ...
  Map<String, dynamic> toJson() => {
        ...
        "items": projectItems == null
            ? null
            : List<dynamic>.from(projectItems!.map((x) => x.toJson())),
      };
}
